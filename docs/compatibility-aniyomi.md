...
| `javax.crypto` (AES)                                | real JCE                                                                                       | **Refused**                                                                              | WebCrypto `subtle.decrypt` behind an `__k.aes` helper; AES-CBC/ECB with PKCS#7 is the whole of what extractors use                                                  | shared runtime               |
